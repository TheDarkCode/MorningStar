...
public:
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About MorningStar", Q_NULLPTR));
        label->setText(QApplication::translate("AboutDialog", "<b>morningstar</b> version", Q_NULLPTR));
...
"Copyright \302\251 2017 The MorningStar developers", Q_NULLPTR));
