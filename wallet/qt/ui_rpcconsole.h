...
public:
    ...
    {
        RPCConsole->setWindowTitle(QApplication::translate("RPCConsole", "morningstar - Debug window", Q_NULLPTR));
        label_9->setText(QApplication::translate("RPCConsole", "morningstar Core", Q_NULLPTR));
        ...
        openDebugLogfileButton->setToolTip(QApplication::translate("RPCConsole", "Open the morningstar debug log file from the current data directory. This can take a few seconds for large log files.", Q_NULLPTR));
        openDataDirButton->setToolTip(QApplication::translate("RPCConsole", "Show the data directory of MorningStar, that includes the blockchain, the wallet and configuration files, the logs and more.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        showCLOptionsButton->setToolTip(QApplication::translate("RPCConsole", "Show the morningstar-Qt help message to get a list with possible morningstar command-line options.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
