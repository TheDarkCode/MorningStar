...
//        logo_label->setFrameStyle(QFrame::StyledPanel);
        ...
        left_logo_pix = QPixmap(":images/morningstar_vertical");
        ...
        bottom_logo_pix = QPixmap(":images/morningstar_horizontal");
...
//        font1.setPointSize(10);
        ...
        spendable_value_label->setText(QStringLiteral("0 MRNG"));
        ...
        stake_value_label->setText(QStringLiteral("0 MRNG"));
        ...
        unconfirmed_value_label->setText(QStringLiteral("0 MRNG"));
        ...
        immature_value_label->setText(QStringLiteral("0 MRNG"));
    ...
    void retranslateUi(QWidget *OverviewPage)
    {
        ...
        labelTransactionsStatus->setToolTip(QApplication::translate("OverviewPage", "The displayed information may be out of date. Your wallet automatically synchronizes with the morningstar network after a connection is established, but this process has not completed yet.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        labelWalletStatus->setToolTip(QApplication::translate("OverviewPage", "The displayed information may be out of date. Your wallet automatically synchronizes with the morningstar network after a connection is established, but this process has not completed yet.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
